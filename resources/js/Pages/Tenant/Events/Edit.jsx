...
export default function EditEvent({ tenant, event }) {
    ...
    const handleDelete = () => {
        if(confirm('Apakah Anda yakin ingin menghapus Event ini? Semua partisipan dan pembayaran akan terhapus.')) {
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="flex items-center justify-between pt-4 border-t">
                                <button type="button" onClick={handleDelete} className="text-red-600 hover:text-red-800 text-sm font-medium">Hapus Event</button>
