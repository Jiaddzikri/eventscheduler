        ...
        <div className="flex h-screen bg-gray-100 font-sans">
            ...
            <div className={`fixed inset-y-0 left-0 z-30 w-64 bg-gray-900 transform transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:inset-auto md:flex md:flex-col ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                ...
                <div className="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                    ...
                    <Link
                        href={route('dashboard.my-events')}
                        className={route().current('dashboard.my-events') ? navItemActive : navItemBase}
                    >
                    ...
                    <Link
                        ...
                        className={route().current('dashboard.payments') ? navItemActive : navItemBase}
                    >
                    ...
                    {user.role === 'admin' && (
                        <>
                            ...
                            <Link
                                ...
                                className={route().current('admin.events.*') ? navItemActive : navItemBase}
                            >
